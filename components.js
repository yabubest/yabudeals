...
function loadGlobalFooter() {
    ...
    footerContainer.innerHTML = `
        ...
        <!-- MODAL IMPRESSUM -->
        <div id="impressumModal" class="modal-overlay" onclick="closeGlobalModal('impressumModal')">
            <div class="modal-content" onclick="event.stopPropagation()">
                <button class="modal-close" onclick="closeGlobalModal('impressumModal')">&times;</button>
                <h2>Impressum</h2>
                <p><strong>YabuDeals</strong></p>
                <p>Angaben gemäß § 5 TMG / Anbieterkennzeichnung.</p>
                <p>E-Mail: kontakt@yabudeals.de</p>
        ...
        <!-- MODAL DATENSCHUTZ -->
        <div id="datenschutzModal" class="modal-overlay" onclick="closeGlobalModal('datenschutzModal')">
            <div class="modal-content" onclick="event.stopPropagation()">
                <button class="modal-close" onclick="closeGlobalModal('datenschutzModal')">&times;</button>
                <h2>Datenschutzerklärung</h2>
                <p>Wir nehmen den Schutz Ihrer persönlichen Daten sehr ernst. Diese Webseite nutzt keine Tracking-Cookies von Drittanbietern ohne Ihre Zustimmung.</p>
                <p><strong>Affiliate-Links:</strong> Diese Webseite enthält Affiliate-Links (u.a. Amazon-Partnerprogramm). Beim Klicken auf einen dieser Links werden Sie auf die Seite des jeweiligen Anbieters weitergeleitet.</p>
            </div>
        </div>
    `;
}
