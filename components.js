/* ---------- GLOBALER FOOTER (OPTIMIERT FÜR BARRIEREFREIHEIT) ---------- */
    ...
    <footer class="site-footer">
      <div class="footer-container">
        ...
        <div class="footer-center">
          <a href="${mapsLink}" target="_blank" rel="noopener noreferrer" class="social-icon" title="Google Maps / Standort" aria-label="Google Maps Standort">
